...
class MovingAverage extends React.Component {
    constructor(props) {
        ...
        this.props.parameters.setMAType("Simple");
    ...
    handleClose(value) {
        ...
        this.props.parameters.setMAType(value);
    }
            ...
            <List>
                <div>
                    ...
                    <ListItem dense className={this.classes.listItem}>
                        <ListItemText
                            id={"labelId"}
                            primary="Type" /*primary={`Line item ${value + 1}`}*/
                        />
                        <ListItemSecondaryAction>
                            <Button
                                variant="contained"
                    ...
                    <Dialog
                        ...
                        onClose={e => this.handleClose(this.state.buttonLabel)}
                    ...
                    >
                        <DialogContent>
                            <RadioSelectorList
                                ...
                                default={this.state.buttonLabel}
...
export default withStyles(styles)(MovingAverage);

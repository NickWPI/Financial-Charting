...
class RSILabel extends Graph {
    ...
    draw(surface, chartProps) {
        ...
        let { origin, period, field, displayFormat, labelType, labelFill, valueFill, fontFamily, fontSize, toolbarItemSpacing, toolbar } = this.properties;
        const { origin: chartOrigin } = chartProps;

        let labelText = `RSI(${period}, ${field})`;
